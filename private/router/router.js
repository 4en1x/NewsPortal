...
router.post('/removeArticle', mustAuthenticatedMw, articleController.removeArticle);
router.post('/createArticle', mustAuthenticatedMw, articleController.createArticle);
router.post('/updateArticle', mustAuthenticatedMw, articleController.updateArticle);
router.get('/', (req, res) => {
